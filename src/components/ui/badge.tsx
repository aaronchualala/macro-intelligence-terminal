...
export function Badge({
  ...
  return (
    <span
      {...props}
      className={cn(
        "inline-flex h-5 max-w-full items-center rounded-[2px] border px-1.5 text-[10px] font-medium uppercase leading-none tracking-wide shadow-[inset_0_1px_0_rgba(255,255,255,0.035)]",
